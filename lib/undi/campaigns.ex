defmodule Undi.Campaigns do
  ...
  alias Undi.Campaigns.Membership
  alias Undi.Campaigns.Receipt
  alias Undi.Campaigns.ExecuteStepWorker
  ...
  def get_campaign_module(:campaign_only_used_in_test), do: Undi.CampaignsTest.TestCampaign
  def get_campaign_module("campaign_only_used_in_test"), do: Undi.CampaignsTest.TestCampaign
  ...
  def not_in_campaign_query(query, campaign) do
    in_campaign_subquery = from(
      m in Undi.Campaigns.Membership,
