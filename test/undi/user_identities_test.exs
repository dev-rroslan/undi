defmodule Undi.UserIdentitiesTest do
  use Undi.DataCase

  import Undi.UsersFixtures
  import Undi.UserIdentitiesFixtures

  alias Undi.UserIdentities
  alias Undi.UserIdentities.UserIdentity
  ...
  describe "find_or_create_user with a new user_identity" do
    test "find_or_create_user/1 it returns ok-account-tuple" do
      ...
      assert {:just_created, %Undi.Users.User{email: "new_user@example.com"}} =
