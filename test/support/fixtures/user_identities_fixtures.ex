defmodule Undi.UserIdentitiesFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Undi.UserIdentities` context.
  """
  ...
  def user_identity_fixture(%User{} = user, attrs) do
    ...
    {:ok, user_identity} = Undi.UserIdentities.create_user_identity(user, attrs)
